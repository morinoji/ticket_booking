        ...
        <div class="container-fluid">
            <div class="page-title">
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <div class="add_style">
                            <a href="{{route('hotloc.create')}}" class="btn btn-success float-right m-2">Thêm</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card-body">
                                <table id="datatable" class="table" style="border-collapse: collapse; border-spacing: 0; width: 100%;table-layout: fixed;">
                                    ...
                                    <tr>
                                        ...
                                        <th class="heading_text">Tên địa điểm</th>

                                        <th class="heading_text">Khu vực</th>
                                    ...
                                    @foreach($sliders as $slider)
                                        <tr>
                                            ...
                                            <td style="width: 20%">
                                                <h6 class="mt-0 mb-1">{{$slider->location_name}}</h6>
                                            </td>

                                            <td style="width: 20%">
                                                <h6 class="mt-0 mb-1">{{$slider->area}}</h6>
                                            </td>
                                            <td>
                                                <a href="{{ route('hotloc.find',['id'=>$slider->id]) }}"
                                                ...
                                                <a data-url="{{ route('hotloc.delete',['id'=>$slider->id]) }}"
