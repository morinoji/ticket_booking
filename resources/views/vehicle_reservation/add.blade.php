                    ...
                    <div class="card-body">
                        <form class="row g-3 needs-validation mt-2"
                            ...
                            <div class="col-md-2" >
                                ...
                                <select class="form-control" id="route"  name="vehicle">
                                    @foreach($vehicles as $index=>$element)
                                        <option  value="{{$element->id}}">{{$element->vehicle_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-2" >
                                <label for="validationCustom04" class="form-label">Hãng xe</label>
                                <select readonly onmousedown="(function(e){ e.preventDefault(); })(event, this)" class="form-control" id="comp"  name="comp">
